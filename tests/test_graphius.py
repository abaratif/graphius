...
class TestGraphius(unittest.TestCase):
    ...
    #     """ Mark the 1:A subtree of example 1 as merged """
    #     g = Graphius(self.EXAMPLE1)
    #     g.markMerged(g.nodes[1])
    #
    #     assert(g.nodes[1].safe is False)
    #     assert(g.nodes[3].safe is False)
    #     assert(g.nodes[7].safe is False)
    #     assert(g.nodes[12].safe is True)
